...
A proof-of-concept MCP Server (Service) with example LLM tool integrations and containerized setup.
...
```
![Claude Desktop](resources/claude_MCP.png "Tool Call")
...
https://claude.ai/public/artifacts/ae67db0e-cf42-47fc-8482-0687b988406f
![Claude Desktop Dashboard](resources/dash-claude.png "Tool Call Dashboard")
